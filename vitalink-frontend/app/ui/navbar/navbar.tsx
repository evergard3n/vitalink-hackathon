...
export default function NavBar() {
  ...
  return (
    <div className="w-full md:w-40 z-20 h-18 lg:h-fit relative bg-linear-to-br from-white to-zinc-150 drop-shadow-xs transition-all duration-200 ease-in backdrop-blur-sm min-h-12 md:border border-b border-zinc-200 md:rounded-lg flex flex-row items-center gap-8  px-4">
